...
WAVE_PATH = get_asset_path('Wave.png')
SLOGAN_PATH = get_asset_path('Slogan.png')
GOSTAR_LOGO_PATH = get_asset_path('gostar_logo.png')

HAS_LOGO = os.path.exists(LOGO_PATH)
HAS_SLOGAN = os.path.exists(SLOGAN_PATH)
HAS_GOSTAR_LOGO = os.path.exists(GOSTAR_LOGO_PATH)
...
<style>
    ...
    .sidebar-centered {{ text-align: center; padding: 20px 10px; }}
    .sidebar-logo {{ max-width: 140px; margin: 0 auto 10px auto; display: block; }}
    .sidebar-slogan {{ max-width: 180px; margin: 0 auto; display: block; }}
...
# =============================================================================
# SIDEBAR - CENTERED LOGO AND SLOGAN, NO ICONS
# =============================================================================
if HAS_LOGO:
...
if HAS_SLOGAN:
    ...
    st.sidebar.markdown(f"""
    <div class="sidebar-centered">
        <img src="data:image/png;base64,{slogan_b64}" class="sidebar-slogan">
    </div>
    """, unsafe_allow_html=True)
else:
    st.sidebar.markdown(f"""
    <div class="sidebar-centered">
        <span class="slogan-gradient" style="font-size: 0.7em;">Where data means more</span>
    </div>
    """, unsafe_allow_html=True)
...
if selected_screen == "Overview":
    ...
    # Bar chart with SOLID deep blue colour (no gradient)
    ...
    fig.update_traces(marker_color=BRAND["deep_blue"])  # Solid colour
    fig.update_layout(
        showlegend=False,
        plot_bgcolor='white',
        paper_bgcolor='white',
